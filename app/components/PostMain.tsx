...
function PostMain({ post }: PostMainCompTypes) {
  ...
  return (
    <>
      <div id={`PostMain-${post.id}`} className="flex border-b py-1">
        ...
        <div className="pl-3 w-full px-4">
          <div className="flex items-center justify-between pb-0.5">
            ...
            <button className="border text-[15px] px-[21px] py-0.5 border-[#F02C56] text-[#F02C56] hover:bg-[#ffeeff] font-semibold rounded-md">
              Follow
            </button>
          </div>
          ...
          <p className="text-[14px] pb-0.5 flex items-center font-semibold">
            <ImMusic size="17" />
            <span className="px-1">original sound - AWSSOME</span>
            <AiFillHeart size="20" />
          </p>
