...
import { CropperDimesions, ShowErrorObject } from "../../type";
...
function EditProfile() {
  ...
  const [cropper, setCropper] = useState<CropperDimesions | null>(null);
  ...
  const getUploadesImage = (event: React.ChangeEvent<HTMLInputElement>) => {
                  ...
                  >
                    ...
                    <div className="flex items-center justify-center sm:-mt-6">
                      ...
                      <input
                        ...
                        className="hidden"
                        id="image"
                        onChange={getUploadesImage}
                        accept="image/img, image/jpeg, image/jpg"
                      />
                    </div>
                  </div>
                  <div
                    id="UserNameSection"
                    className="flex flex-col border-b sm:h-[118px] px-1.5 py-2 w-full"
                  >
                    <h3 className="font-semibold text-[15px] sm:mb-0 mb-1 text-gray-700 sm:w-[160px] sm:text-left text-center">
                      Name
                    </h3>
