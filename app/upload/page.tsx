      ...
      <UploadLayout>
        <div className="w-full mt-[80px] mb-[40px] bg-white shadow-lg rounded-md py-6 md:px-10 px-4">
          <div>
            ...
            <h2 className="text-gray-400 mt-1">Post a video your account</h2>
          </div>
            ...
            {!fileDisplay ? (
              <>
                ...
                >
                  ...
                  <p className="mt-4 text-sm text-gray-400">MP4</p>
                  ...
                  <label
                    htmlFor="fileInput"
                    className="px-2 p-1.5 mt-8 text-white text-[15px] w-[80%] bg-[#F02C56] rounded-sm cursor-pointer"
                  >
                    Select File
                  </label>
                  <input
              ...
              <>
                <div className="md:mx-0 mx-auto mt-4 md:mb-12 mb-16 flex items-center justify-center w-full max-w-[260px] h-[540px] p-3 rounded-2xl cursor-pointer relative">
                  ...
                  <div className="absolute -bottom-12 flex justify-between z-50 rounded-xl border w-full p-2 border-gray-300">
